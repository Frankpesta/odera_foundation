			...
			<div className="container relative z-20 flex h-full flex-col items-center justify-center px-4 text-white">
				<motion.div
					...
					<motion.div variants={titleVariants} className="overflow-hidden">
						<h1 className="font-sans text-6xl font-extrabold tracking-tight sm:text-7xl md:text-8xl mb-2">
					...
					<motion.div
						...
						<h1 className="font-sans text-6xl font-extrabold tracking-tight sm:text-7xl md:text-8xl">
				...
				<motion.div
					...
					<motion.div whileHover="hover" whileTap="tap">
						<Button
							asChild
							size="lg"
							className="relative overflow-hidden bg-emerald-600 text-white transition-all hover:bg-emerald-700 text-lg px-8 py-3 h-auto">
							<Link href="/donate">
					...
					<motion.div whileHover="hover" whileTap="tap">
						<Button
							...
							size="lg"
							variant="outline"
							className="border-emerald-400 text-emerald-100 backdrop-blur-sm transition-all hover:bg-emerald-800/30 text-lg px-8 py-3 h-auto">
